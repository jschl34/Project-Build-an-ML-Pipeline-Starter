...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help = "Input file to be cleaned", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str, ## INSERT TYPE HERE: str, float or int,
        help = "Name of clean file", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        ...
        help = "The minimum price in the artifact", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float, ## INSERT TYPE HERE: str, float or int,
        help = "The maximum price in the artifact", ## INSERT DESCRIPTION HERE,
        required = True
    )
